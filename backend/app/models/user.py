...
class User(Base):
    ...
    # Set the first time the user confirms a verification link; null means
    # unverified. Verification gates capability-gated endpoints (analyses,
    # inference, insurance checks, robotics inspections) -- see
    # app.security.require_verified.
