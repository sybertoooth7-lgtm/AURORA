...
tags_metadata = [
    ...
    {"name": "Admin", "description": "Account administration -- listing, disabling, enabling users."},
]
...
async def rate_limit(request: Request, call_next):
    """Per-IP request throttle, backed by Redis so the limit holds
    regardless of how many API replicas are running.
    ...
    key = f"ratelimit:{'auth' if is_auth_endpoint else 'api'}:{client_host}"
